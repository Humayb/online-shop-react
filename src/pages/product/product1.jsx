...
//             دسته بندی 
//         </h4>
//         <ul className="col-sm-6 row menu-items">
//             <li className="col ">
//                 <a href="" >
//                    زنانه
//                    <span className="">
...
//             </li>
//         </ul>
//         <h4 className="col-sm-4 d-none d-sm-block d-flex justify-content-end">
//             <a className="col-1" href=""><AiOutlineSearch/></a>
//             <a className="col-1" href=""><AiOutlineShoppingCart/></a>
//         </h4>
//     </div>
//     )
// }
...
//             <Slider {...settings} className="col-10  slider">
...
//             <div className="col-sm-2 Right-list">
//                 <ul className="col-12">
//                     <li>مانتو و پالتو</li>
//                     <li>لباس مجلسی</li>
//                     <li>کفش زنانه</li>
